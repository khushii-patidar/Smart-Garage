# Generated by Django 6.1.1 on 2026-09-03 07:05
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('OWNER', 'Owner / Admin'), ('ADVISOR', 'Service Advisor'), ('MECHANIC', 'Mechanic'), ('CUSTOMER', 'Customer')], default='CUSTOMER', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('specialization', models.CharField(blank=True, help_text='e.g. Engine, Electrical, AC, Bodywork', max_length=100)),
